...
def run_roslaunch1():
    ...
    if ur5:
        command = 'roslaunch ur5_gripper_moveit_config demo.launch'
...
def run_roslaunch2():
    ...
    if ur5:
        command = 'roslaunch ur5_gripper_moveit_config ' +\
        'ur5_gripper_moveit_planning_execution.launch sim:=true limited:=true'
